  ...
  stages {
	...
	steps{
		withSonarQubeEnv('sonaqube') {
			bat "\"${tool 'sonar-msbuild'}\"\\SonarScanner.MSBuild.exe begin /k:testSonarqube /v=\"1.0\" /d:sonar.host.url=http://192.168.1.253:9000 /d:sonar.login=1ec69f715c3bbba2837928c2dc265300ec2f6ac3"
